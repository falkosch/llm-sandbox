...
if __name__ == "__main__":
    model_names = [
        # ~16GB @ BF16, https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct
        'meta-llama/Llama-3.1-8B-Instruct',
        # ~141GB @ BF16, https://huggingface.co/meta-llama/Llama-3.1-70B-Instruct
        'meta-llama/Llama-3.1-70B-Instruct',
        # ~812GB @ BF16, https://huggingface.co/meta-llama/Llama-3.1-405B-Instruct
